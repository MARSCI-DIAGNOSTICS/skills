...
# -*- coding: utf-8 -*-
"""
script_utils.py - Small shared helpers for codex-cli-docs scripts.
...
def normalize_url_for_display(url: str | None) -> str | None:
    ...
    Examples:
        normalize_url_for_display("https://developers.openai.com/codex/cli.md")
        -> "https://developers.openai.com/codex/cli"

        normalize_url_for_display("https://developers.openai.com/codex/cli.md#features")
        -> "https://developers.openai.com/codex/cli#features"

        normalize_url_for_display("https://developers.openai.com/codex/cli#features")
        -> "https://developers.openai.com/codex/cli#features"  (unchanged)
