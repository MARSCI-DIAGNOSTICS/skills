...
# Changed from Gemini-Docs-Scraper to Codex-Docs-Scraper
USER_AGENT = get_default('http', 'user_agent', "Codex-Docs-Scraper/1.0 (Educational purposes)")
...
def fetch_with_retry(
    ...
    Example:
        >>> response = fetch_with_retry("https://developers.openai.com/codex/cli")
