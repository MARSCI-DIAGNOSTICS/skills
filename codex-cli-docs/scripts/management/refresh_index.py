...
# -*- coding: utf-8 -*-
"""
refresh_index.py - One-shot orchestration to refresh the codex-cli-docs index
...
try:
    ...
    def get_base_dir(start=None):
        ...
        return repo_root / "plugins" / "openai-ecosystem" / "skills" / "codex-cli-docs" / "canonical"
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        description='Refresh codex-cli-docs index (rebuild, extract keywords)',
    ...
    print("=" * 80)
    print("OpenAI Codex CLI Docs - refresh_index.py")
