...
content_hash: sha256:b3c7adc4b567f8e64d3fe081fe823fc18126ede6aaea60f96b147d652721044d
...
---
# Windows
The [Codex app for Windows](https://apps.microsoft.com/detail/9plm9xgg6vks?hl=en-US≷=US) gives you one interface for
...
[Microsoft Store](https://apps.microsoft.com/detail/9plm9xgg6vks?hl=en-US≷=US).
...
- Uses a private desktop by default for stronger UI isolation. Set `windows.sandbox\_private\_desktop = false` only if you need the older `Winsta0\\Default` behavior for compatibility.
### Sandbox permissions
Running Codex in full access mode means Codex is not limited to your project
directory and might perform unintentional destructive actions that can lead to
