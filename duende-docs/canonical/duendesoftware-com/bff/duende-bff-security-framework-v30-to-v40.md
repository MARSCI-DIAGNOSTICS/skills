...
source_url: https://docs.duendesoftware.com/bff/duende-bff-security-framework-v30-to-v40/
source_type: llms-full-txt
content_hash: sha256:4778f759bda1db6b3b5b338ad93640617be4ae3260974dc0cbf2be15839ef949
category: bff
doc_id: bff/duende-bff-security-framework-v30-to-v40
---
...
[Section titled "Remote APIs"](#remote-apis)
...
[Section titled "Configuring Token Types In YARP"](#configuring-token-types-in-yarp)

The required token type configuration in YARP has also changed slightly. It uses the enum values from `RequiredTokenType`.

### Extending The BFF

[Section titled "Extending The BFF"](#extending-the-bff)

#### Service To Endpoint Updates

[Section titled "Service To Endpoint Updates"](#service-to-endpoint-updates)
...
[Section titled "Custom Session Store"](#custom-session-store)
...
[Section titled "Access Token Retrieval"](#access-token-retrieval)
...
[Section titled "Simplified Wireup Without Explicit Authentication Setup"](#simplified-wireup-without-explicit-authentication-setup)
...
[Section titled "Adding Multiple Frontends"](#adding-multiple-frontends)
...
[Section titled "Loading Configuration From IConfiguration"](#loading-configuration-from-iconfiguration)
