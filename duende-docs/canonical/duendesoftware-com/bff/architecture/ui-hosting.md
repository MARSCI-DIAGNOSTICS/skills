---
title: UI Hosting
source_url: https://docs.duendesoftware.com/bff/architecture/ui-hosting/
source_type: llms-full-txt
content_hash: sha256:77e00787e9affc0376f0f4f1b729a513faadfff6e44c6d0b32e7d134a19fd43b
doc_id: bff/architecture/ui-hosting
---
...
[Section titled "Hosting Options for the UI"](#hosting-options-for-the-ui)
...
[Section titled "Serving SPA assets from BFF host"](#serving-spa-assets-from-bff-host)
...
![Hosting BFF UI from the UI](/_astro/bff_ui_hosting_loc.Cidk5i8u_29iGln.svg)
...
Microsoft's templates are easy-to-use at dev time from Visual Studio. They allow you to run the solution, and the template proxies requests to the front end for you. At deploy time, that proxy is removed and the static assets of the site are served by the static file middleware.

### Host The UI Separately

[Section titled "Host The UI Separately"](#host-the-ui-separately)
...
![Hosting BFF UI on CDN](/_astro/bff_ui_hosting_cdn.BhY4WhaY_Z2d9oUI.svg)
...
[Section titled "Serve The Index Page From The BFF Host"](#serve-the-index-page-from-the-bff-host)
...
![BFF Proxies the Index html from CDN](/_astro/bff_ui_hosting_proxy_index.C6Kqvm-L_1dnBiP.svg)
