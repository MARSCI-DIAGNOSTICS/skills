---
title: Architecture
source_url: https://docs.duendesoftware.com/bff/architecture/
source_type: llms-full-txt
content_hash: sha256:f686636e96054a267724533a0c79e8aeffde09eadcd8cbca6a9bd024bc58d1b5
doc_id: bff/architecture
---
...
![BFF Security Framework Architecture Overview](/_astro/bff_application_architecture.IlwGmaoW_Z1IY0QR.svg)
...
Duende.BFF builds on widely used tools and frameworks, including ASP.NET Core's OpenID Connect and cookie authentication handlers, YARP, and [Duende.AccessTokenManagement](/accesstokenmanagement/). Duende.BFF combines these tools and adds additional security and application features that are useful with a BFF architecture so that you can focus on providing application logic instead of security logic:

![Duende BFF Security Framework - components](/_astro/bff_blocs.CgltHOg__Z2rhLmC.svg)

### ASP.NET OpenID Connect Handler

[Section titled "ASP.NET OpenID Connect Handler"](#aspnet-openid-connect-handler)
...
[Section titled "ASP.NET Cookie Handler"](#aspnet-cookie-handler)
...
[Section titled "Duende.AccessTokenManagement"](#duendeaccesstokenmanagement)
...
[Section titled "UI Assets"](#ui-assets)
...
[Section titled "Blazor Support"](#blazor-support)
