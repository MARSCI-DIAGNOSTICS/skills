...
source_url: https://docs.duendesoftware.com/pushed-authorization-requests/
source_type: llms-full-txt
content_hash: sha256:cf541e8ac1197ac1941fdfe03b69793739d2fd7da6d3dedfc81f92b34bfd6af8
doc_id: pushed-authorization-requests
---
...
[Section titled "Client Usage"](#client-usage)
...
.NET 8 does not have built-in support for PAR. If you're using .NET 8, we have a sample of how to implement this flow available [here](/identityserver/samples/basics/#mvc-client-with-pushed-authorization-requests).

## Data Store

[Section titled "Data Store"](#data-store)
