...
source_url: https://docs.duendesoftware.com/identityserver/tokens/client-authentication/
source_type: llms-full-txt
content_hash: sha256:efbe09c047317af0f4ae5561fd326cbc88001ac9896e8c2ffaf39b31f0b4d555
doc_id: identityserver/tokens/client-authentication
---
...
[Section titled "Assigning Secrets"](#assigning-secrets)
...
[Section titled "Secret Parsing"](#secret-parsing)
...
[Section titled "Secret Validation"](#secret-validation)
...
[Section titled "Shared Secrets"](#shared-secrets)
...
[Section titled "Authentication Using A Shared Secret"](#authentication-using-a-shared-secret)
...
[Section titled "Private Key JWTs"](#private-key-jwts)
...
[Section titled "Setting Up A Private Key JWT Secret"](#setting-up-a-private-key-jwt-secret)
...
[Section titled "Authentication Using A Private Key JWT"](#authentication-using-a-private-key-jwt)
...
...and the [Duende IdentityModel](/identitymodel/) client library to programmatically interact with the protocol endpoint from .NET code.
...
[Section titled "Using ASP.NET Core"](#using-aspnet-core)
...
You can enable strict audience validation using the [*`StrictClientAssertionAudienceValidation`*](/identityserver/reference/options/#strict-audience-validation) flag, which always strictly validates that the audience is equal to the issuer and validates the token's `typ` header, as specified in [RFC 7523 bis](https://datatracker.ietf.org/doc/draft-ietf-oauth-rfc7523bis/).
...
[Section titled "Mutual TLS Client Certificates"](#mutual-tls-client-certificates)
...
[Section titled "Configuring IdentityServer to Accept Client Certificates"](#configuring-identityserver-to-accept-client-certificates)
...
[Section titled ".NET Client Library"](#net-client-library-2)
