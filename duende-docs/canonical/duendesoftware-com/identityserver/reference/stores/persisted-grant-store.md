...
source_url: https://docs.duendesoftware.com/identityserver/reference/stores/persisted-grant-store/
source_type: llms-full-txt
content_hash: sha256:4ada9d178fcdc9a1b280df46a285b0b80be2d142a454a3164b0938837d72a71d
doc_id: identityserver/reference/stores/persisted-grant-store
---
...
[Section titled "Duende.IdentityServer.Stores.IPersistedGrantStore"](#duendeidentityserverstoresipersistedgrantstore)
...
| Task\<IEnumerable> GetAllAsync(PersistedGrantFilter filter, CancellationToken ct); | Retrieves all grants that fulfill the conditions of a filter. |
...
[Section titled "Duende.IdentityServer.Models.PersistedGrant"](#duendeidentityservermodelspersistedgrant)
...
[Section titled "Key Property"](#key-property)
...
[Section titled "Data Property"](#data-property)
...
[Section titled "Time Stamps"](#time-stamps)
...
[Section titled "PersistedGrantFilter"](#persistedgrantfilter)
...
[Section titled "PersistedGrantTypes"](#persistedgranttypes)
