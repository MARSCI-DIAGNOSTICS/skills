...
source_url: https://docs.duendesoftware.com/identityserver/diagnostics-data/
source_type: llms-full-txt
content_hash: sha256:870a08cfba852cd1382a102d3e5a314e5e66ec6eb45e545fb622ac61123f51e3
category: identityserver
doc_id: identityserver/diagnostics-data
---
...
[Section titled "Diagnostics Data Contents"](#diagnostics-data-contents)
...
[Section titled "Capturing Diagnostics Data"](#capturing-diagnostics-data)
...
[Section titled ".NET Core Default Logger"](#net-core-default-logger)
...
[Section titled "Serilog"](#serilog)
...
* In code
  ...
  In the `AddSerilog()` extension method's configuration builder, you can add a file logger that filters log messages and only emits those from the `Duende.IdentityServer.Diagnostics.Summary` category.
...
[Section titled "log4net"](#log4net)
...
[Section titled "Diagnostics Data Format"](#diagnostics-data-format)
