...
source_url: https://docs.duendesoftware.com/identityserver/requesting-tokens/
source_type: llms-full-txt
content_hash: sha256:161b1cf104e9ce8bb84bd93156795e743525e1eceb37a8795cb0fb13d7d2285d
category: identityserver
doc_id: identityserver/requesting-tokens
---
...
[Section titled "How To Request Tokens"](#how-to-request-tokens)
...
[Section titled "Token Types"](#token-types)

The following token types are supported.

### Identity Token

[Section titled "Identity Token"](#identity-token)

During user authentication, your IdentityServer collects data about the user, e.g. authentication method, authentication time, some protocol information, and a unique identifier for the user that was authenticated. This data is used to communicate back to the client application "what happened at the token service".
