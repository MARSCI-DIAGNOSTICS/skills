...
source_url: https://docs.duendesoftware.com/identityserver/identityserver4-v41-to-duende-identityserver-v6/
source_type: llms-full-txt
content_hash: sha256:9762c3ef3d3cf61cb7c95bb1c06379cad7beaacdbe819d3820387ae60be80c2b
category: identityserver
doc_id: identityserver/identityserver4-v41-to-duende-identityserver-v6
---
...
[Section titled "Step 4: Remove AddDeveloperSigningCredential"](#step-4-remove-adddevelopersigningcredential)
...
[Section titled "Step 5: Update Database Schema (if needed)"](#step-5-update-database-schema-if-needed)
...
[Section titled "Step 6: Migrating signing keys (optional)"](#step-6-migrating-signing-keys-optional)
...
[Section titled "Step 7: Verify Data Protection Configuration"](#step-7-verify-data-protection-configuration)
...
[Section titled "Step 8: Done!"](#step-8-done)
