...
source_url: https://docs.duendesoftware.com/identityserver/duende-identityserver-v62-to-v63/
source_type: llms-full-txt
content_hash: sha256:075733c8c4778efbd3ad5ec3616866a3f73f0384b588336cbc47cf281bac3db2
category: identityserver
doc_id: identityserver/duende-identityserver-v62-to-v63
---
...
[Section titled "Step 2: Update Database Schema (if necessary)"](#step-2-update-database-schema-if-necessary)
...
[Section titled "Step 3: Verify Data Protection Configuration"](#step-3-verify-data-protection-configuration)
