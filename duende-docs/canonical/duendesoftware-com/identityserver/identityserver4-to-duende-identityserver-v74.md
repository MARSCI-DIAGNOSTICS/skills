...
source_url: https://docs.duendesoftware.com/identityserver/identityserver4-to-duende-identityserver-v74/
source_type: llms-full-txt
content_hash: sha256:17d46c312b1555ea2041dd10d7dcd2d46007c72243ca8c8c665fccb331fe0256
category: identityserver
doc_id: identityserver/identityserver4-to-duende-identityserver-v74
---
...
[Section titled "IdentityServer4 UI Templates"](#identityserver4-ui-templates)

Note

Check your current host project's UI elements against the latest templates in **[`Duende.Templates`](/identityserver/overview/packaging/)** to ensure you're using the latest recommendations and best practices.
...
[Section titled "IdentityServer4 v3.x to IdentityServer v4.x"](#identityserver4-v3x-to-identityserver-v4x)
...
[Section titled "Step 1: Update NuGet Packages"](#step-1-update-nuget-packages)
...
[Section titled "Step 2: Make Code Changes"](#step-2-make-code-changes)

It's likely some code changes will be required, especially when using the IdentityServer UI templates. [Visual Studio](https://visualstudio.microsoft.com/) and [JetBrains Rider](https://www.jetbrains.com/rider/) provide great code completion that can be of help here.
...
If you are using the `IdentityServer4.EntityFramework` package to store configuration and operational data in a [database](/identityserver/data/), you'll need to create two database migrations that update the database schema. Note that you may want to change the database migration paths in the examples below to reflect your project structure.
...
[Section titled "IdentityServer4 v4.x to Duende IdentityServer"](#identityserver4-v4x-to-duende-identityserver)
...
[Section titled "Step 1: Update the .NET Version"](#step-1-update-the-net-version)
...
[Section titled "Step 3: Update Namespaces"](#step-3-update-namespaces)
...
[Section titled "Step 4: Remove AddDeveloperSigningCredential "Optional](#step-4-remove-adddevelopersigningcredential)
...
You can use Duende IdentityServer's built-in [manual or automatic key management](/identityserver/fundamentals/key-management/) instead.

### Step 5: Update Database Schema

[Section titled "Step 5: Update Database Schema"](#step-5-update-database-schema)

Whether you are using a [database](/identityserver/data/) or a [custom store implementation](/identityserver/reference/stores/) for your configuration and operational data, you'll need to make some changes. The exact steps involved in updating your data store will depend on your implementation details.
...
[Section titled "Step 6: Migrate Signing Keys "Optional](#step-6-migrate-signing-keys)
...
[Section titled "Step 7: Verify Data Protection Configuration "Optional](#step-7-verify-data-protection-configuration)
...
[Section titled "Step 8: Validate Your Deployment"](#step-8-validate-your-deployment)
