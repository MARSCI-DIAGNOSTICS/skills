...
source_url: https://docs.duendesoftware.com/identityserver/protecting-an-api-with-client-credentials/
source_type: llms-full-txt
content_hash: sha256:970027144213574c4129504737d98092cebde4a98878902b4ab22ab17fc8f099
category: identityserver
doc_id: identityserver/protecting-an-api-with-client-credentials
---
...
[Section titled "Create The Solution And IdentityServer Project"](#create-the-solution-and-identityserver-project)
...
[Section titled "Defining An API Scope"](#defining-an-api-scope)
...
[Section titled "Defining The client"](#defining-the-client)
...
[Section titled "Configuring IdentityServer"](#configuring-identityserver)
...
![Browser showing discovery endpoint JSON](/_astro/1_discovery.CglV0FSW_uefJN.webp)
...
[Section titled "Create An API Project"](#create-an-api-project)
...
[Section titled "Add An Endpoint"](#add-an-endpoint)
...
[Section titled "Configure API To Listen On Port 6001"](#configure-api-to-listen-on-port-6001)
...
[Section titled "Test The Identity Endpoint"](#test-the-identity-endpoint)
...
[Section titled "Create The Client Project"](#create-the-client-project)
...
[Section titled "Add The IdentityModel NuGet Package"](#add-the-identitymodel-nuget-package)
...
[Section titled "Retrieve The Discovery Document"](#retrieve-the-discovery-document)
...
If you get an error connecting, it may be that the development certificate for `localhost` is not trusted. You can run *dotnet dev-certs https --trust* in order to trust the development certificate. This only needs to be done once.

### Request A Token From IdentityServer

[Section titled "Request A Token From IdentityServer"](#request-a-token-from-identityserver)
...
Copy and paste the access token from the console to [jwt.me](https://jwt.me) to inspect the raw token.

### Calling The API

[Section titled "Calling The API"](#calling-the-api)
...
![Windows console showing claims for a bearer token](/_astro/1_client_screenshot.DapOaE8B_Z21a1sv.webp)
...
[Section titled "Authorization At The API"](#authorization-at-the-api)
