...
source_url: https://docs.duendesoftware.com/entity-framework-core-configuration-operational-data/
source_type: llms-full-txt
content_hash: sha256:36908b0719cf80106b33b10fdd5e063986ca69e457e7a6221a4f7462b73b568b
doc_id: entity-framework-core-configuration-operational-data
---
...
[Section titled "Install Microsoft.EntityFrameworkCore.Sqlite"](#install-microsoftentityframeworkcoresqlite)
...
[Section titled "Configuring The Stores"](#configuring-the-stores)
...
[Section titled "Managing Database Schema"](#managing-database-schema)

The `Duende.IdentityServer.EntityFramework.Storage` NuGet package (installed as a dependency of `Duende.IdentityServer.EntityFramework`) contains entity classes that map onto IdentityServer's models. These entities are maintained in sync with IdentityServer's models - when the models are changed in a new release, corresponding changes are made to the entities. As you use IdentityServer and upgrade over time, you are responsible for your database schema and changes necessary to that schema.
...
[Section titled "Adding Migrations"](#adding-migrations)
...
[Section titled "Handle Expected Exception"](#handle-expected-exception)
...
[Section titled "Initializing Database"](#initializing-database)
...
![SQLiteStudio showing the contents of an IdentityServer database](/_astro/ef_database.CgdRJRsh_ZtgcXf.webp)
...
[Section titled "Run The Client Applications"](#run-the-client-applications)
