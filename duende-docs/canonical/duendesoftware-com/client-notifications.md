...
source_url: https://docs.duendesoftware.com/client-notifications/
source_type: llms-full-txt
content_hash: sha256:59b48666b0abe14e01fdf0d1638759ad56627e681894acb885393d25a8a4810d
doc_id: client-notifications
---
...
[Section titled "Notifying Clients That The User Has Signed Out"](#notifying-clients-that-the-user-has-signed-out)
...
[Section titled "Front-channel Server-side Clients"](#front-channel-server-side-clients)
...
[Section titled "Back-channel Server-side Clients"](#back-channel-server-side-clients)
...
[Section titled "Implementing Back-channel Logout In .NET Applications"](#implementing-back-channel-logout-in-net-applications)
...
[Section titled "Browser-based JavaScript Clients"](#browser-based-javascript-clients)
