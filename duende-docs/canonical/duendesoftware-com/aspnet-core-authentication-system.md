...
source_url: https://docs.duendesoftware.com/aspnet-core-authentication-system/
source_type: llms-full-txt
content_hash: sha256:1962da6b3b3b5c96c616438960471e46788c88ae1fd3a8f6c16056fda025b73e
doc_id: aspnet-core-authentication-system
---
...
To configure authentication in the BFF, you'll need to configure both the OpenID Connect login flow and the cookie handlers.

## Automatic Authentication Configuration V4

[Section titled "Automatic Authentication Configuration "](#automatic-authentication-configuration)
...
[Section titled "Manually Configuring Authentication"](#manually-configuring-authentication)
...
[Section titled "The OpenID Connect Authentication Handler"](#the-openid-connect-authentication-handler)
...
[Section titled "The Cookie Handler"](#the-cookie-handler)
...
[Section titled "Choosing Between SameSite.Lax and SameSite.Strict"](#choosing-between-samesitelax-and-samesitestrict)
