...
source_url: https://docs.duendesoftware.com/integrating-with-external-providers/
source_type: llms-full-txt
content_hash: sha256:1d854892fbd0a67549dccc3df52dac99280f15017270b0bc3d9afc5f60f4f048
doc_id: integrating-with-external-providers
---
...
[Section titled "External Identity Providers"](#external-identity-providers)
...
[Section titled "Registering Authentication Handlers For External Providers"](#registering-authentication-handlers-for-external-providers)

Supporting an external provider is achieved by registering the handler in your IdentityServer's startup configuration. For example, to use employee logins from Azure AD (AAD):
...
[Section titled "Triggering The Authentication Handler"](#triggering-the-authentication-handler)
...
[Section titled "The Role Of Cookies In External Logins"](#the-role-of-cookies-in-external-logins)
...
[Section titled "Sign In Scheme"](#sign-in-scheme)
...
[Section titled "Sign Out Scheme"](#sign-out-scheme)
...
[Section titled "Handling The Callback"](#handling-the-callback)
...
[Section titled "Inspecting The External Identity"](#inspecting-the-external-identity)
...
[Section titled "Establish Session, Clean Up, And Resume Workflow"](#establish-session-clean-up-and-resume-workflow)
...
[Section titled "State, URL length, And ISecureDataFormat"](#state-url-length-and-isecuredataformat)
...
[Section titled "Third-Party ASP.NET Core Authentication Handlers"](#third-party-aspnet-core-authentication-handlers)
...
| Many social providers in [AspNet.Security.OAuth.Providers](https://github.com/aspnet-contrib/AspNet.Security.OAuth.Providers) *Airtable, Apple ID, GitHub, Hubspot, Instagram, Okta, Slack, ...* | Open-source          |
