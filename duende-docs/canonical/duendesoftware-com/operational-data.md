...
source_url: https://docs.duendesoftware.com/operational-data/
source_type: llms-full-txt
content_hash: sha256:a0bd91c5d6beeb3fa962773c1abc9d3448ab986cc38718e3402eadef49209f3d
doc_id: operational-data
---
...
[Section titled "Registering Custom Stores"](#registering-custom-stores)
...
[Section titled "Grant Expiration and Consumption"](#grant-expiration-and-consumption)
...
[Section titled "Grant Data"](#grant-data)
...
[Section titled "Persisted Grant Service"](#persisted-grant-service)
...
[Section titled "Signing Key Store"](#signing-key-store)
...
[Section titled "Registering a custom signing key store"](#registering-a-custom-signing-key-store)
...
[Section titled "Key Lifecycle"](#key-lifecycle)
...
[Section titled "Serialized Key"](#serialized-key)
...
[Section titled "Server-Side Session Store"](#server-side-session-store)
...
[Section titled "Registering a custom store"](#registering-a-custom-store)
...
[Section titled "EntityFramework Store Implementation"](#entityframework-store-implementation)
