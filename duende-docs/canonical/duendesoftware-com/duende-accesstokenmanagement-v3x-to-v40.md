...
source_url: https://docs.duendesoftware.com/duende-accesstokenmanagement-v3x-to-v40/
source_type: llms-full-txt
content_hash: sha256:8c9fc02a233dbf7a8bff56be46ee5f0a1b08caba3d33eaef0641b02895ffd228
doc_id: duende-accesstokenmanagement-v3x-to-v40
---
...
[Section titled "Moving Towards HybridCache Implementation And Away from Distributed Cache"](#moving-towards-hybridcache-implementation-and-away-from-distributed-cache)
...
[Section titled "Complete Internal Refactoring"](#complete-internal-refactoring)
...
[Section titled "Reduced Public API Surface"](#reduced-public-api-surface)
...
We still want to ensure our users' extensibility needs are met, but via more controlled mechanisms. If you find that you have an extensibility need not covered by the new model, please raise a discussion [in our discussion board](https://duende.link/community). If this is a scenario we want to support, we'll do our best to accommodate it.

### Explicit Extension Model

[Section titled "Explicit Extension Model"](#explicit-extension-model)
...
[Section titled "Composition Over Inheritance"](#composition-over-inheritance)
...
[Section titled "Strongly Typed Configuration"](#strongly-typed-configuration)
...
[Section titled "Renamed classes"](#renamed-classes)
