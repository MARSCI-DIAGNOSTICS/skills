...
source_url: https://docs.duendesoftware.com/proof-of-possession-access-tokens/
source_type: llms-full-txt
content_hash: sha256:ba441caa3f1187321758cde48b4f9d6ea8801951dba3a0c7ef94e0c03ac2236c
doc_id: proof-of-possession-access-tokens
---
...
[Section titled "Proof-of-Possession Styles"](#proof-of-possession-styles)
...
[Section titled "Combine TLS Proof-of-possession With Other Authentication Methods"](#combine-tls-proof-of-possession-with-other-authentication-methods)
...
[Section titled ".NET Client"](#net-client)
...
[Section titled "Enabling Support In IdentityServer"](#enabling-support-in-identityserver)
...
[Section titled "Demonstrating Proof-of-Possession at the Application Layer (DPoP)"](#demonstrating-proof-of-possession-at-the-application-layer-dpop)
...
The client must then prove possession of the private key to call the APIs, and your APIs can [validate](/identityserver/apis/aspnetcore/confirmation/) the `cnf` claim by comparing it to the thumbprint of the client's public key in the JWK.
...
[Section titled "Enabling DPoP In IdentityServer"](#enabling-dpop-in-identityserver)
...
[Section titled "Enabling DPoP Support In Your Client"](#enabling-dpop-support-in-your-client)
...
[Section titled "Enabling DPoP Support In Your API"](#enabling-dpop-support-in-your-api)
