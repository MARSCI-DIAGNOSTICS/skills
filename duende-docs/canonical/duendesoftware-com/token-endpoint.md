...
source_url: https://docs.duendesoftware.com/token-endpoint/
source_type: llms-full-txt
content_hash: sha256:70e359ddb2dbbf99d1d03468389d3b982a71e89a8e8b9b71abfa4d7c25a42ad9
doc_id: token-endpoint
---
...
[Section titled "Requesting a token"](#requesting-a-token)
...
[Section titled "Requesting a token using the client\_credentials Grant Type"](#requesting-a-token-using-the-client_credentials-grant-type)
...
[Section titled "Requesting a token using the password Grant Type"](#requesting-a-token-using-the-password-grant-type)
...
[Section titled "Requesting a token using the authorization\_code Grant Type"](#requesting-a-token-using-the-authorization_code-grant-type)
...
[Section titled "Requesting a token using the refresh\_token Grant Type"](#requesting-a-token-using-the-refresh_token-grant-type)
...
[Section titled "Requesting a Device Token"](#requesting-a-device-token)
