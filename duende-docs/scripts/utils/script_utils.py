...
# -*- coding: utf-8 -*-
"""
script_utils.py - Small shared helpers for duende-docs scripts.
...
def normalize_url_for_display(url: str | None) -> str | None:
    ...
    Examples:
        normalize_url_for_display("https://docs.duendesoftware.com/identityserver/overview.md")
        -> "https://docs.duendesoftware.com/identityserver/overview"

        normalize_url_for_display("https://docs.duendesoftware.com/bff/getting-started.md#features")
        -> "https://docs.duendesoftware.com/bff/getting-started#features"

        normalize_url_for_display("https://docs.duendesoftware.com/identitymodel/overview#features")
        -> "https://docs.duendesoftware.com/identitymodel/overview#features"  (unchanged)
