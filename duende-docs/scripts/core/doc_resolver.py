...
class DocResolver:
    ...
    def __init__(self, base_dir: Path):
        ...
        # Load index once per resolver instance
    ...
    def search_by_keyword(self, keywords: list[str], category: str | None = None,
        ...
        for doc_id in candidate_doc_ids:
            ...
            best_keyword_position = len(doc_keywords)
            ...
            domain_key = domain
            if domain == 'docs.duendesoftware.com' and doc_category_for_weight:
                domain_key = f'docs.duendesoftware.com/{doc_category_for_weight}'
    ...
    def get_content(self, doc_id: str, section: str | None = None) -> dict[str, Any | None]:
        ...
        if MarkdownExtractor is None:
            return {
                ...
                'warning': 'Warning: Do not store file paths. Use doc_id references or invoke duende-docs skill for access.'
            }
...
Examples:
  ...
  python doc_resolver.py duendesoftware-com-identityserver-overview

  # Resolve and show metadata
  python doc_resolver.py duendesoftware-com-identityserver-overview --show-metadata
""",
    )
