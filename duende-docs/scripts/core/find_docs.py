...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Find and resolve Duende documentation references',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  # Resolve doc_id to path (using default base directory)
  python find_docs.py resolve duendesoftware-com-identityserver-overview

  # Resolve doc_id and output JSON (for tools/agents)
  python find_docs.py --json resolve duendesoftware-com-identityserver-overview

  # Get full document content
  python find_docs.py content duendesoftware-com-identityserver-overview

  # Get specific section content
  python find_docs.py content duendesoftware-com-identityserver-overview --section "Installation"

  # Search by keywords
  python find_docs.py search oauth tokens refresh

  # Natural language search
  python find_docs.py query "how to configure client credentials flow"

  # List by category
  python find_docs.py category identityserver

  # List by tag
  python find_docs.py tag oauth

  # Find related docs
  python find_docs.py related duendesoftware-com-identityserver-overview

Categories:
  identityserver         - IdentityServer OAuth/OIDC framework
  bff                    - Backend-for-Frontend security
  accesstokenmanagement  - Token lifecycle management
  identitymodel          - Protocol operations library
  identitymodel-oidcclient - Native OIDC client library
  introspection          - Token introspection
  general                - Licensing, support, glossary
        """
    )
