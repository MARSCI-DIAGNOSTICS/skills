...
Provides commands to clear and inspect caches used by the duende-docs plugin.
...
def cmd_info(cm: CacheManager) -> int:
    ...
    print("Duende Docs - Cache Status\n")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Cache management for duende-docs plugin',
