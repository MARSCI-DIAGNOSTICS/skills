...
content_hash: sha256:7f10fb93035a11a8b323ea491958bef89f5f123f21692fa96b2e1868b5b8547e
...
The `absolutePath` in the response is a filesystem path, not a URL. Use the [download endpoint](https://cursor.com/docs/cloud-agent/api/endpoints.md#download-an-artifact) with this path to get a presigned download URL.
