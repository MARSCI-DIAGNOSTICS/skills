...
content_hash: sha256:a3bf33ef232e067bf25169945ffc783e2c6b1c1ef6ee6a2aa5c6af77e3fc301a
...
You must have [on-demand usage](https://cursor.com/docs/account/teams/pricing.md#on-demand-usage) enabled to use cloud agents, which allows you to continue using models after the amount included in your subscription is consumed.
...
- You need to be on a trial or paid plan with [on-demand usage](https://cursor.com/docs/account/teams/pricing.md#on-demand-usage) enabled.
- To enable usage-based pricing, go to your [Dashboard](https://www.cursor.com/dashboard/settings) settings tab.
