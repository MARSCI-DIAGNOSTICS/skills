...
content_hash: sha256:783ef74c1d72084fe094d3d6dc1243f3ca3969819820771b76e7fc3f08e9812d
...
5. Back on the Integrations tab, click **Manage** next to your GitLab connection and select **Sync Repos**
6. Return to the dashboard to enable Bugbot on specific repositories
...
1. Go to [Cursor Dashboard](https://cursor.com/dashboard/integrations) → **Advanced** → **GitHub Enterprise Server**
...
1. Go to [cursor.com/dashboard](https://cursor.com/dashboard/integrations) → **Advanced** → **GitLab Self-Hosted**
...
8. Enable Bugbot on specific repositories from the [Bugbot tab in the dashboard](https://cursor.com/dashboard/bugbot)
...
Available with Enterprise Bugbot. Allow Cursor to access your instance over a private network connection. [Contact your Cursor representative](https://cursor.com/contact-sales?source=docs-bugbot-private-network) for setup.
