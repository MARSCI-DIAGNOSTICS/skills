...
content_hash: sha256:3810834b1be7b6e1232145f6726043df40f9ab1ffa11f806aa55d57e5c579696
...
| [Claude 4.6 Opus](https://www.anthropic.com/claude/opus)                                      | Anthropic | 200k            | 1M       | Agent, Thinking, Images | Requires Max Mode on request-based plans; Up to 1M tokens in Max Mode at the same per-token rates (no long-context surcharge)                                                                                                                                                                                                                 |
...
| [GPT-5.4](https://developers.openai.com/api/docs/models/gpt-5.4)                              | OpenAI    | 272k            | 1M       | Agent, Thinking, Images | Requires Max Mode on request-based plans; Agentic and reasoning capabilities; 90% discount on cached input tokens; Fast mode is 15% faster with 2x pricing; Long context (Max Mode) supports up to 1M tokens with 2x input pricing                                                                                                            |
