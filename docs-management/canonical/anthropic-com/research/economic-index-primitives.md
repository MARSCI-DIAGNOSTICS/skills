...
source_type: sitemap
content_hash: sha256:8787ee333eb4af69862a53868c35613d27c0e905981863023273cda6cba8aee2
...
We're able to complement METR's analysis using our economic primitives. In the graph below, we show Claude's task-level success rates relative to the amount of time a human would take to do the same task, both on [Claude.ai](http://claude.ai/redirect/website.v1.NORMALIZED) and on our API:
