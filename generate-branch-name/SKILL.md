...
description: Generate a semantic Git branch name from issue context for ADW workflows. Use before starting work on an issue.
argument-hint: "<type: feat|fix|chore> [short-id] <issue-title-or-description>"
