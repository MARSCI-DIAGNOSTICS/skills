...
argument-hint: "[--status | --check | --audit [type] | --audit-all | --apply | --validate | --audit-required | --since <version> | --discover]"
allowed-tools: Read, Write, Bash, Glob, Grep, Skill, Task
---
