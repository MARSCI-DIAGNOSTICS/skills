...
2. Replace the placeholders:
   - `_EVAL_DATA_PLACEHOLDER_` → the JSON array of eval items (no quotes around it — it's a JS variable assignment)
   - `_SKILL_NAME_PLACEHOLDER_` → the skill's name
   - `_SKILL_DESCRIPTION_PLACEHOLDER_` → the skill's current description
